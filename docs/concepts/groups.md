...
See [Group messages](/concepts/group-messages) for WhatsApp-only behavior (history injection, mention handling details).[Markdown Formatting](/concepts/markdown-formatting)